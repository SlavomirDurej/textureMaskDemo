package com.durej.test.scenes
{
	...
	public class TextScene extends Scene
	{
		...
		private function init() : void
		{
			...
			var colorTF : TextField = new TextField(300, 80, "TextFields can have a border and a color. They can be aligned in different ways, ...", ttFont, ttFontSize);
			...
			var fontTF : TextField = new TextField(300, 80, "... or centered. Embedded fonts are detected automatically and " + "<font color='#208080'>support</font> " + "<font color='#993333'>basic</font> " + "<font color='#333399'>HTML</font> " + "<font color='#208020'>formatting</font>.", ttFont, ttFontSize, 0x0, true);
			fontTF.x = offset;
