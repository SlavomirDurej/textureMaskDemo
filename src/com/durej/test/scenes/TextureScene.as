	...
	public class TextureScene extends Scene
	{
		public function TextureScene()
		{
			...
			catch (e : Error)
			{
				...
				var textField : TextField = new TextField(220, 128, "Update to Flash Player 11.4 or AIR 3.4 (swf-version=17) to see a compressed " + "ATF texture instead of this boring text.", "Verdana", 14);
