package com.durej.test.scenes
{
	...
	import com.durej.test.utils.RoundButton;

	public class CustomHitTestScene extends Scene
	{
		public function CustomHitTestScene()
		{
			var description : String = "Pushing the bird only works when the touch occurs within a circle." + "This can be accomplished by overriding the method 'hitTest'.";
